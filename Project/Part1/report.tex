...
\section{Technology Stack}
    ...
    \subsection{Visualization Tools}
        We chose to use Chartjs for visualization of stock data over time, which will include projected stock pricing.
        For graph visualization, we will be utilizing sigma.js.
